...
public class AliPayController {
    ...
    public String alipayReturnNotice(HttpServletRequest request, HttpServletRequest response) throws Exception {
        ...
        String addressId=params.get("address_id");

        String oId=out_trade_no.substring(out_trade_no.length()-2);
...
//        }
        ...
        return "http://localhost:8080";//成功返回首页
    }
