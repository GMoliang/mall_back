package nuc.gml.mall.config.Ali.pay;
...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
   ...
   // public final static String NOTIFY_URL = "/ali/alipayNotifyNotice";
    //支付宝同步通知路径,也就是当付款完毕后跳转本项目的页面,可以不是公网地址
    public final static String RETURN_URL = "http://localhost:9001/order/aliPay?payStatus=t";
